...
def crawl_by_threading(url, comment_count):
    com_dict = {}
    com_url_list = []
    like_count_list = []
    qualified_post = 0
    ...
    with futures.ThreadPoolExecutor(max_workers=4) as executor:
        results = executor.map(crawl_comment, com_url_list)
...
def main():
    ...
    com_dict, like_count = crawl_by_threading(url, comment_count)
